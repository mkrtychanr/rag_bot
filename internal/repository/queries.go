...
const (
	...
	deletePapersFromPaperGroupQuery      = "delete from paper_group where paper_id = any($1)"
	deletePapersFromPapersQuery          = "delete from papers where id = any($1)"
	deleteGroupsFromGroupUserQuery       = "delete from group_user where group_id = any($1)"
	deleteGroupsFromPaperGroupQuery      = "delete from paper_group where group_id = any($1)"
	deleteGroupsFromGroupsQuery          = "delete from groups where id = any($1)"
	...
	getGroupsInfoQuery                   = "select id, name, admin from groups where id = any($1)"
	getPapersInfoQuery                   = "select id, name, author_id from papers where id = any($1)"
	getUsersInfoQuery                    = "select id, name, tg_id from users where id = any($1)"
	...
	getUserIDsWithAccessTypeInGroupQuery = "select user_id from group_user where group_id = $1 and access_type_id = $2"
