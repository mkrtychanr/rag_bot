...
class Vectorestore:
    ...
    async def generate_answer(self, query, context, document_ids=None, model="gpt-4o-mini"):
        ...
        system_prompt = """
Ты — эксперт в области безопасности жизнедеятельности. Твоя задача — предоставить информацию, которая будет полезна для учеников. Используй только данные из предоставленных документов, избегай домыслов и неподтвержденной информации.
"""
